...
public class DeleteCoinoder extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.e("tettetetetetetettetet",Constants.DeleteOrderCoin);
        if(Constants.DeleteOrderCoin.equals("")){
            ...
            cartItems.addAll((List<OpenOrderModelCoin>) new Gson().fromJson(Constants.DeleteOrderCoin, new TypeToken<ArrayList<OpenOrderModelCoin>>() {
            }.getType()));
        }
