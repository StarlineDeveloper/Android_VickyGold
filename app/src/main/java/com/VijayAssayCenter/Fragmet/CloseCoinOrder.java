...
public class CloseCoinOrder extends Fragment {

    RecyclerView rv_cart;
    CategoryOpenOrder cartItems;


    public CloseCoinOrder() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.e("tettetetetetetettetet", Constants.ClosedOrderCoin);
        if (Constants.ClosedOrderCoin.equals("")) {
            ...
            cartItems.addAll((List<OpenOrderModelCoin>) new Gson().fromJson(Constants.ClosedOrderCoin, new TypeToken<ArrayList<OpenOrderModelCoin>>() {
            }.getType()));
        }
    ...
    public class CategoryOpenOrder extends RecyclerView.Adapter<CategoryOpenOrder.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_close, parent, false);
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            holder.close_price2.setText("Close Price: " + PaperList.get(position).getClosePrice());
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            public MyViewHolder(View view) {
                ...
                close_price2 = view.findViewById(R.id.close_price2);
