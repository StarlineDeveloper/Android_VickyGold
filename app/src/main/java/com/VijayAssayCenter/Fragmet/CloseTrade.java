...
public class CloseTrade extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_close_trade, container, false);

        Log.e("tettetetetetetettetet", Constants.ClosedOrder);
        if (Constants.ClosedOrder.equals("")) {
            ...
            cartItems.addAll((List<OpenOrderModel>) new Gson().fromJson(Constants.ClosedOrder, new TypeToken<ArrayList<OpenOrderModel>>() {
            }.getType()));
        }
