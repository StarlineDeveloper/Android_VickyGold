...
public class StoreName extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lay_skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent MainActivity=new Intent(StoreName.this, MainActivity.class);
        ...
        lay_start.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (et_store_name.getText().toString().trim().length() == 0) {
                    et_store_name.setError("Enter Store Name");
                    et_store_name.requestFocus();
                }else {
                    if (isConnected()) {
                        StoreName=et_store_name.getText().toString().trim();
                        ...
                        Toast.makeText(StoreName.this, "Not Connected to Internet!!!", Toast.LENGTH_LONG).show();
